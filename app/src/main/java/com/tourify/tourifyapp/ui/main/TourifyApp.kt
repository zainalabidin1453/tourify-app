...
fun TourifyApp(
    ...
    Scaffold(bottomBar = {
        if (currentRoute != Routes.SplashSreen.routes && currentRoute != Routes.CheckEmail.routes && currentRoute != Routes.VerifCode.routes && currentRoute != Routes.EnterPassword.routes && currentRoute != Routes.CreatePassword.routes && currentRoute != Routes.ScanObjek.routes) {
